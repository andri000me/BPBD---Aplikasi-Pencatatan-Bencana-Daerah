                  ...
                  <div class="row">
                    <div class="col-md-12 px-1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Kejadian" name="nama" id="nama" required>
                      </div>
                      <div class="form-group">
                        <label>Kategori Kategori</label>
                        <input type="text" class="form-control" placeholder="Kategori Kejadian" name="kategori" id="kategori" required>
                      </div>
                    </div>
                  </div>
                </div>
