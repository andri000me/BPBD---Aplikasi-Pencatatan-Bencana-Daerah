            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">
                  <h5 class="title">Ubah Kategori</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group">
                        <label>KODE</label>
                        <input type="text" class="form-control" placeholder="Kode" name="kode" id="kode" value="<?=$detail["kode"];?>" required>
                      </div>
                      <div class="form-group">
                        <label>Nama Kota</label>
                        <input type="text" class="form-control" placeholder="Nama Kejadian" name="kejadian" id="kejadian" value="<?=$detail["kejadian"];?>" required>
                        <input type="hidden" name="id" id="id" value="<?=$detail["kode"];?>">
                      </div>
                      <div class="form-group">
                        <label>Nama Kota</label>
                        <input type="text" class="form-control" placeholder="Kategori Kejadian" name="kategori" id="kategori" value="<?=$detail["kategori"];?>" required>
                      </div>
                    </div>
                  </div>
                </div>
