                  ...
                  <div class="col-md-12 px-1">
                    ...
                    <div class="col-md-12 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama Kecamatan" name="kecamatan" id="kecamatan" value="<?= $detail['nama_kecamatan'];?>" required>
                        <input type="hidden" name="id" id="id" required value="<?= $detail['id_kecamatan'];?>">
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <script type="text/javascript">
    $(function(){
       $('.select2').select2({
           ...
           ajax: {
              dataType: 'json',
              url: '<?= $domain;?>kecamatan.php?halaman=daftar-kota-list',
              delay: 800,
